...
class VideoLibrary:
    ...
    def get_vid_from_title(self, video_title):
        """Returns the video object (title, url, tags) from the video library.

        Args:
            video_title: The video url.

        Returns:
            The Video object for the requested video_title. None if the video
            does not exist.
        """
        return self._videos.get(video_title, None)
